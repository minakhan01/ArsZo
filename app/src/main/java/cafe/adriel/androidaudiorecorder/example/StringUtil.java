...
public class StringUtil {
    ...
    static ResponseStates findReplyResponseState(String str) {
        if (introAll.contains(str.toLowerCase())) {
            return ResponseStates.INTRO;
        }
        else if (editorialAll.contains(str.toLowerCase())) {
            return ResponseStates.EDITORIAL;
        }
        else if (instructionsTwoAll.contains(str.toLowerCase())) {
            return ResponseStates.LEVEL_TWO;
        }
        else if (instructionsOneAll.contains(str.toLowerCase())) {
            return ResponseStates.LEVEL_ONE;
        }
        else if (outroAll.contains(str.toLowerCase())) {
            return ResponseStates.OUTRO;
        }
        return ResponseStates.OTHER;
    }

    static int findReplyResponseInt(String str) {
